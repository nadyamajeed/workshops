...
eta1 = rnorm(n = 500, m = 0, sd = sample(seq(0.1, 1, 0.1), 1))
eta2 = 0.4*eta1 + rnorm(n = 500, m = 0, sd = sample(seq(0.2, 1, 0.1), 1))
eta3 = 0.4*eta2 - 0.2*eta1 + rnorm(n = 500, m = 0, sd = sample(seq(0.2, 1, 0.1), 1))
...
myData = 
  data.frame(
    ...
    i4 = 3*(sample(possibleFactorLoadings, 1)*eta2 + rnorm(n = 500, m = 0, sd = sample(seq(0.1, 1, 0.1), 1))),
    ...
    i7 = 3*(sample(possibleFactorLoadings, 1)*eta3 + rnorm(n = 500, m = 0, sd = sample(seq(0.1, 1, 0.1), 1))),
    i8 = 3*(sample(possibleFactorLoadings, 1)*eta3 + rnorm(n = 500, m = 0, sd = sample(seq(0.1, 1, 0.1), 1))),
    i9 = 3*(sample(possibleFactorLoadings, 1)*eta3 + rnorm(n = 500, m = 0, sd = sample(seq(0.1, 1, 0.1), 1)))
  ) |>
  round()
