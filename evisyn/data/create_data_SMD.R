...
m1 = rnorm(n = no_of_samples, mean = 3, sd = 0.5) |> round(2)
sd1 = 
...
m2 = m1 - rnorm(n = no_of_samples, mean = 2.5, sd = 0.5) |> round(2)
sd2 = 
  (sample((0.5*n_max):(1.25*n_max), size = no_of_samples, replace = TRUE) /
     n2 * 2.5) |> 
  round(2)
...
data_recorded_A$m1 = with(data_recorded_A, ifelse(country == "B", m1 + 0.25, m1))
